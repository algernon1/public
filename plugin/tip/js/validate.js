...
function clsValidateCtrl()
{
	...
	this.validateAll= clsValidateCtrl$validateAll;
}
...
function clsValidateCtrl$showInfo()
{
...
function clsValidateCtrl$validateAll()
{
	var bln = true;
	for(var key in errMsg)
	{
		...
		for(var nI=0; nI<ctrlList.length; nI++)
		{
			if($(ctrlList[nI]).parents("*[id*='template']").length == 0)
			{
